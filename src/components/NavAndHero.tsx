    ...
    return (
        <div>
            ...
            <nav className="flex justify-between pl-30 pr-30 pt-10">
                <div className="text-black gap-6 lg:flex hidden">
            ...
            <div className="relative w-full h-[550px] pt-8 flex flex-col items-center justify-center">
                ...
                <div className="absolute flex flex-col items-center justify-center gap-4 z-30">
                    <h1 className={`text-[#FFFFFF] text-center font-extrabold text-5xl ${interFont.className}`}>Welcome To
                        Exclusive Discounts</h1>
                    <h1 className={`text-[#FFFFFF] text-center font-extrabold text-5xl ${interFont.className}`}>& Savings</h1>
                    <p className={`text-[#FFFFFF] text-center font-medium text-xl ${montSerrat.className}`}>Get access to
